...
MLIR_FILE = TEST_DIR / "addmulc.mlir"
...
def test_addcmul():
    ...
    # Same values as the constants baked into addmulc.mlir
    input_val   = [[1.0, 2.0], [3.0, 4.0]]
    tensor1_val = [[2.0, 3.0], [4.0, 5.0]]
    tensor2_val = [[5.0, 6.0], [7.0, 8.0]]
    value = 2.0
