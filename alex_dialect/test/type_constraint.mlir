  ...
  //CHECK: "alex.practise"
  //CHECK: testAttr
  //CHECK: "alex.practise"(%arg0, %arg1) <{testAttr = [1.110000e+00 : f32, 2.220000e+00 : f32, 3.330000e+00 : f32]}> : (tensor<2x3xi32>, tensor<2x3xi32>) -> tensor<2x3x4xf32>

  func.func @add_with_optional(%arg0: tensor<2x3xi32>, %arg1: tensor<2x3xi32>) -> tensor<2x3x4xf32> {
    %0 = "alex.practise"(%arg0, %arg1) {
